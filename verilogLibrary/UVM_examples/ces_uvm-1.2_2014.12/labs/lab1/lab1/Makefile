...
compile_switches = -sverilog -fsdb +vcs+vcdpluson -debug_all -timescale="1ns/100ps" -l comp.log ${TEST_TOP} +define+${uvm_defines}+${defines}
...
simv compile: *.sv ${TEST_TOP}
	vcs -ntb_opts ${uvm_ver} ${compile_switches}
