...
#define SV_STRING char*
 ...
 extern int snps_reg__get_reg_array_id(/* INPUT */const char* path, /* INPUT */const char* name, /* INPUT */int index);

 extern int snps_reg__get_fld_id(/* INPUT */const char* path, /* INPUT */const char* rg, /* INPUT */const char* name);

 extern int snps_reg__get_fld_array_id(/* INPUT */const char* path, /* INPUT */const char* rg, /* INPUT */const char* name, /* INPUT */int index);
