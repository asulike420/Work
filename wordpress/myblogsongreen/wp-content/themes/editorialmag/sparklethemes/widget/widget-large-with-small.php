<?php
/**
 * Adds editorialmag_large_with_small_widget widget.
*/
add_action('widgets_init', 'editorialmag_large_with_small_widget');

function editorialmag_large_with_small_widget() {
    register_widget('editorialmag_large_with_small_widget_area');
}

class editorialmag_large_with_small_widget_area extends WP_Widget {
    ...
    */
    public function __construct() {
        parent::__construct(
            'emag_magazine_small_posts', esc_html_x('EMag Large With Small Posts', 'widget name', 'editorialmag'),
            array(
                'classname' => 'emag_magazine_small_posts',
                'description' => esc_html__('Widget display 1 large thumbinal image post with multiple small thumbinal posts', 'editorialmag'),
